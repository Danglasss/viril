(function () {
  ...
  function Review({ title, text, name }) {
    return React.createElement('div', { style: { background: 'rgba(255,255,255,.06)', border: '1px solid rgba(255,255,255,.12)', borderRadius: 0, padding: 12 } },
  ...
  function AnalyzeResults() {
    ...
    React.useEffect(() => {
      ...
      const dur = 2000; // 2s per bar (faster!)
      let raf = 0;
      function step(ts) {
