  ...
  function ResultsSale() {
    ...
    return React.createElement('div', null,
      ...
      (function () {
        ...
        return Block('Résumé personnel basé sur tes réponses', React.createElement('div', {
          style: {
        ...
        function Row(icon, label, value) {
          return React.createElement('div', {
            ...
            React.createElement('div', {
              style: {
                width: 36, height: 36, borderRadius: 0, display: 'flex', alignItems: 'center', justifyContent: 'center',
                background: 'rgba(255,255,255,.06)', border: '1px solid rgba(255,255,255,.12)', fontSize: 20
              }
            }, icon),
        ...
        return Block('Choisit le meilleur plan pour toi', React.createElement('div', null,
          ...
          React.createElement('div', { style: { marginTop: 16, display: 'flex', justifyContent: 'flex-end' } },
            React.createElement('button', {
              className: 'btn primary', style: { width: 'auto', borderRadius: 0, padding: '12px 18px', color: '#FFFFFF', fontWeight: 800 }, onClick: function () {
